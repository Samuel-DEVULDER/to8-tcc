...
* stores only sign class. One byteis enough.
opCMP_1 lda     #1
        sta     <R0hi
        pulu    pc
opCMP_m1
...
* opEXT* handler below. SKIP2_X is the trick: executed as "LDX #imm",
...
opMOD   pulu    d
        leay    b,s
opMODa  ldb     <R0hi   ; real  work starts here
        stb     ,-s     ; save  R0 sign
        bpl     opMODb
        jsr     <NEG_   ; make it positive
opMODb  ldb     ,y
        stb     ,-s     ; save "y" sign
        bpl     opMODc
        jsr     <NEG_Y  ; make "y" positive
opMODc  jsr     <UDIV_Y
...
opMODd  ldb     ,s+     ; get initial sign of R0
        bpl     opMODe
        jsr     <NEG_   ; make (R0%y)of the samesign as R0
opMODe  pulu    pc
...
* B-offset indexed, no leax needed). Same SKIP2_X trick as the EXT
